...
/**
 * Class for the shooter of the robot which takes boulders
 * from the shooter motor and shoots it. It incorporates PID
 * and commands to guide it towards the high goal.
 */
...
public class Shooter extends Subsystem {
	...
	/**
	 * Constructs a Talon object, then retrieves the shooter motor from the RobotMap.
	 */
